defmodule MaveMetricsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MaveMetricsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MaveMetricsWeb.Gettext, "errors", msg, opts)
    end
  end
