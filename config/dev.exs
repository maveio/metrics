...
config :mave_metrics, MaveMetricsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "mzHoiVo5KCbmWV1OUyWJQe6VJan3G2HJcoI/SkvfMOGWD2iwgjHzpq3qWILF2Ie4",
  watchers: [
...
config :mave_metrics, MaveMetricsWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/mave_metrics_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :mave_metrics, dev_routes: true
